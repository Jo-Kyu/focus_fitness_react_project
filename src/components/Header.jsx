        ...
        <div className="container">
            <nav className="navbar navbar-expand-lg glass-navbar">
                ...
                <a className="navbar-brand fw-bold" href="#">
                    <img src="https://github.com/Jo-Kyu/focus_fitness_project/blob/dev/assets/images/logos/FOCUS-FITNESS-logo-3-long-big.png?raw=true" alt="Logo-Focus" style={{ width: "137px", height: "60px" }} className="d-none d-lg-block"/>
                    <img src="https://github.com/Jo-Kyu/focus_fitness_project/blob/dev/assets/images/logos/FOCUS-FITNESS-logo-3-long-small.png?raw=true" alt="Logo" style={{ width: "36px", height: "40px" }} className="d-block d-lg-none"/>
                </a>
                {/* Toggler (手機選單按鈕) */}
                ...
                <div className="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                    <ul className="navbar-nav column-gap-6">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle nav-pill no-caret" 
                            ...
                            <ul className="dropdown-menu custom-dropdown-menu mt-2 mb-2" aria-labelledby="navbarDropdownMenuLink">
                                <li><a className="dropdown-item" href="#">健身器材</a></li>
                                <li><a className="dropdown-item" href="#">運動服飾</a></li>
                                <li><a className="dropdown-item" href="#">營養補給</a></li>
                            </ul>
                        </li>
                        {/* 知識專欄 */}
                        <li class="nav-item">
                            <a class="nav-link nav-pill" href="#">知識專欄</a>
                        </li>
                    </ul>
                </div>
                {/* 右側功能區 */}
