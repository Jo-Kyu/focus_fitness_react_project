      ...
      <main className="px-6 position-relative overflow-hidden">
          ...
          <div className="row flex-column flex-lg-row">
            ...
            <div className="col-12 col-lg-6">
              ...
              <div className="mb-3 border border-secondary-600 border-radius-12 p-7 hover-effect">
                ...
                <div className="collapse mt-2 text-black" id="collapseExample">
              ...
              <div className="mb-3 border border-secondary-600 border-radius-12 p-7 hover-effect">
                ...
                {/* 購物須知內容 */}
                <div className="collapse mt-2 text-black" id="shopping-tips">
                  {/* 運送方式 */}
              ...
              <div className="border border-secondary-600 border-radius-12 p-7 hover-effect">
                ...
                {/* 優惠活動內容 */}
                <div className="collapse mt-2 text-black" id="special-offers">
                  <div className="card card-body p-0 text-gray-950 border-0 transparent">
                    <ul className="mb-0 list-unstyled">
                      {/* <優惠活動一 */}
        ...
        <section className="p-0 mb-8 mb-md-11 container max-w-1296">
          ...
          <div className="position-relative">
            <Swiper
              className="d-flex flex-nowrap scroll position-relative"
            ...
            >
              {evaluateCustomerPics.map((evaluateCustomerPic) => {
                return (
                  <>
                    <SwiperSlide
                      className="card me-6 me-md-3 py-6 px-3 p-md-7 rounded-4 bg-blue-600 max-w-312 flex-grow-0 flex-shrink-0"
                      key={evaluateCustomerPic.id}
                    >
                      {/* 卡片標題 */}
                      <div className="mb-1 mb-md-6 d-flex align-items-center">
                        <div className="me-6">
                          <img
                            ...
                            src={evaluateCustomerPic.img}
                            alt="客戶照片"
                          />
                        </div>
                        <div>
                          <h3 className="mb-0 fs-8 fs-md-7 text-white fw-bold">
                            {evaluateCustomerPic.name}
                          </h3>
                        </div>
                      </div>
                      {/* 卡片評價 */}
            ...
            <div className="position-absolute top-lg-50 left--70 bottom--8 d-flex justify-content-between w-100">
              <button
                type="button"
                className="btn bg-white-opacity-20 p-6 rounded-circle d-flex align-items-center justify-content-center translate-middle-y position-absolute left-lg--70 hover-effect-3 carousel-prev d-none d-lg-flex z-100"
              >
                <svg
                  width="16"
                  height="16"
