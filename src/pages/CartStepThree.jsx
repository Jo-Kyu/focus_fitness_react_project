  ...
  return (
    <>
        <main className="overflow-hidden position-relative">
            ...
            />
            {/* 購物車步驟 */}
            <section className="cart-status container py-0 px-0 max-w-md-822 max-w-346">
                <ul className="ps-0 mb-0 d-flex justify-content-lg-between justify-content-center">
                    ...
                    <li className="d-flex align-items-center  me-md-3 ">
                        <div className="me-md-8 me-2 bg-primary-500 rounded-circle 
                                    py-106 py-md-103 px-2 px-md-102 max-w-md-64 max-w-26 max-h-md-64 max-h-26 
                    ...
                    <li className="d-flex  me-md-3 align-items-center">
                        <div
                            className="me-md-8 me-2 bg-primary-500 rounded-circle
                                py-106 py-md-103 px-2 px-md-102 max-w-md-64 max-w-26 max-h-md-64 max-h-26
                                d-flex justify-content-center align-items-center"
                        >
                            <h2 className="fs-8 fs-md-2 fw-bold lh-sm text-gray-900">2</h2>
                        </div>
                        <div className="d-flex align-items-center">
                            <div className="me-6">
                    ...
                    <li className="d-flex align-items-center">
                        <div
                            className="me-md-8 me-2 bg-primary-500 rounded-circle
                                ...
                                d-flex justify-content-center align-items-center"
                        >
                            <h2 className="fs-8 fs-md-2 fw-bold lh-sm text-gray-900">3</h2>
                        </div>
                        <div className="d-flex align-items-center">
                            <div className=" me-1 me-md-6">
                                <p className="fs-9 fs-md-5 text-white">完成結帳</p>
                            </div>
                            <div>
                                <svg
            ...
            <div className="container">
                <section className="order-info mb-4 mb-lg-9">
                    <div className="d-flex flex-column justify-content-center align-items-center">
                        <h4 className="fs-4 fs-lg-1 fw-bold text-gray-950 mb-3 mb-lg-4">感協您的購買，訂單已成立</h4>
                        <p className="fs-6 fs-lg-3 fw-bold text-gray-950"><span className="text-gray-500">訂單編號：</span>0000000000</p>
                    </div>
                </section>
                {/* 提醒 */}
                <section className="notes-info mb-4 mb-lg-9">
                    <div className="d-flex flex-column justify-content-center align-items-center">
                        <h5 className="fs-3 fw-bold text-danger-normal mb-6 mb-lg-8">提醒</h5>
                        <p className="fs-8 fs-lg-7 text-white text-center mb-2 mb-lg-3">若您有購買健身課程相關服務或<br className="d-block d-lg-none"/>入場方案(免配送商品)。</p>
                        <p className="fs-8 fs-lg-7 text-white text-center mb-2 mb-lg-3">結帳完成後，請務必至實體門市櫃台，<br className="d-block d-lg-none"/>出示訂單編號，並辦理相關手續。<br/>
                            請攜帶身分證、健保卡。
                        </p>
                        <p className="fs-8 fs-lg-7 text-white text-center mb-2 mb-lg-0">若有任何疑問，請洽官方線上客服或<br className="d-block d-lg-none"/>致電實體門市。<br/>
                            <span className="d-none d-lg-block">實體門市客服電話：(02) 2765-4321。</span>
                        </p>
                        <p className="fs-8 text-white text-center d-block d-lg-none">實體門市客服電話：(02) 2765-4321。</p>
                    </div>
                </section>
            </div>
            {/* 繼續購物&查看訂單 */}
        ...
        <div className="back-top">
            <a href="#top" className="d-block">
                ...
                <path className="back-top-bg" d="M0 32C0 14.3269 14.3269 0 32 0C49.6731 0 64 14.3269 64 32C64 49.6731 49.6731 64 32 64C14.3269 64 0 49.6731 0 32Z" fill="white" fill-opacity="0.2"/>
