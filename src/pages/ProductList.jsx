import PLBGGlow from "../components/PLBGGlow";
              ...
              <div className="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <div className="accordion" id="accordionExample">
                  <div className="accordion-item border-radius-12 mb-7">
                      <button className="nav-link px-6 py-3 fs-7 active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">所有商品</button>
                  </div>
                  <div className="accordion-item px-6 border-radius-12 mb-7">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                      <div className="accordion-body px-0 pb-1">
                        <button className="nav-link mb-3" id="v-pills-two-tab" data-bs-toggle="pill" data-bs-target="#v-pills-two" type="button" role="tab" aria-controls="v-pills-two" aria-selected="false">重量訓練專區</button>
                        <button className="nav-link mb-3" id="v-pills-three-tab" data-bs-toggle="pill" data-bs-target="#v-pills-three" type="button" role="tab" aria-controls="v-pills-three" aria-selected="false">瑜伽伸展專區</button>
                        <button className="nav-link mb-3" id="v-pills-four-tab" data-bs-toggle="pill" data-bs-target="#v-pills-four" type="button" role="tab" aria-controls="v-pills-four" aria-selected="false">核心訓練專區</button>
                        <button className="nav-link mb-3" id="v-pills-five-tab" data-bs-toggle="pill" data-bs-target="#v-pills-five" type="button" role="tab" aria-controls="v-pills-five" aria-selected="false">有氧訓練專區</button>
                        <button className="nav-link mb-3" id="v-pills-six-tab" data-bs-toggle="pill" data-bs-target="#v-pills-six" type="button" role="tab" aria-controls="v-pills-six" aria-selected="false">按摩放鬆專區</button>
                        <button className="nav-link mb-3" id="v-pills-seven-tab" data-bs-toggle="pill" data-bs-target="#v-pills-seven" type="button" role="tab" aria-controls="v-pills-seven" aria-selected="false">輔助訓練專區</button>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item px-6 border-radius-12 mb-7">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                      <div className="accordion-body px-0 pb-1">
                        <button className="nav-link mb-3" id="v-pills-eight-tab" data-bs-toggle="pill" data-bs-target="#v-pills-eight" type="button" role="tab" aria-controls="v-pills-eight" aria-selected="false">重量訓練</button>
                        <button className="nav-link mb-3" id="v-pills-nine-tab" data-bs-toggle="pill" data-bs-target="#v-pills-nine" type="button" role="tab" aria-controls="v-pills-nine" aria-selected="false">瑜伽</button>
                        <button className="nav-link mb-3" id="v-pills-ten-tab" data-bs-toggle="pill" data-bs-target="#v-pills-ten" type="button" role="tab" aria-controls="v-pills-ten" aria-selected="false">有氧</button>
                        <button className="nav-link mb-3" id="v-pills-elevent-tab" data-bs-toggle="pill" data-bs-target="#v-pills-elevent" type="button" role="tab" aria-controls="v-pills-elevent" aria-selected="false">筋膜放鬆</button>
                        <button className="nav-link mb-3" id="v-pills-twelve-tab" data-bs-toggle="pill" data-bs-target="#v-pills-twelve" type="button" role="tab" aria-controls="v-pills-twelve" aria-selected="false">知識講座</button>
                      </div>
                    </div>
                  </div>
                  <div className="accordion-item px-6 border-radius-12 mb-7">
                    ...
                    <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                      <div className="accordion-body px-0 pb-1">
                        <button className="nav-link mb-3" id="v-pills-thirteen-tab" data-bs-toggle="pill" data-bs-target="#v-pills-thirteen" type="button" role="tab" aria-controls="v-pills-thirteen" aria-selected="false">單次入場</button>
                        <button className="nav-link mb-3" id="v-pills-fourteen-tab" data-bs-toggle="pill" data-bs-target="#v-pills-fourteen" type="button" role="tab" aria-controls="v-pills-fourteen" aria-selected="false">包月入場</button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="tab-content" id="v-pills-tabContent">
                <div className="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  ...
                  <div className="row d-flex justify-content-between align-items-center mb-2 mb-md-7">
                      <div className="col-6">
                          <p className="fw-bold text-gray-950 fs-mg-8 fs-9">共有<span className="fs-8 fs-md-7 mx-2">65</span>樣商品</p>
                      </div>                
                      ...
                      <div className="col-5 d-flex justify-content-end">
                        ...
                        <ul className="dropdown-menu w-100 p-2 mt-1" aria-labelledby="dropdownMenuButton1">
                            <li><a className="dropdown-item fs-8" href="#">熱銷排行</a></li>
                            <li><a className="dropdown-item fs-8" href="#">最新上市</a></li>
                            <li><a className="dropdown-item fs-8" href="#">商城推薦</a></li>
                            <li><a className="dropdown-item fs-8" href="#">價格高至低</a></li>
                            <li><a className="dropdown-item fs-8" href="#">價格低至高</a></li>
                        </ul>
                        </div>
                  ...
                  <div className="row mlr--10 mb-4">
                      {/* 商品1 */}
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          <div
                          className="card rounded-3 bg-blue-600 flex-grow-0 flex-shrink-0 hover-effect-3 overflow-hidden"
                          >
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/商城/product-2.jpg"
                              ...
                              >
                                  ...
                                  <span
                                      className="badge py-1 px-6 bg-danger-normal fs-8 text-white fw-bold"
                                      >熱銷</span
                                  >
                                  <span
                                      className="badge py-1 px-6 bg-primary-400 fs-8 text-blue-900 fw-bold"
                                      >最新上市</span
                                  >
                                  </div>
                                  {/* 收藏符號 */}
                                  <div
                                  className="p-2 color-primary-400 bg-gray-900-20 blur-30 rounded-2 border-top-left-radius-0 border-bottom-right-radius-0 ms-auto"
                                  >
                                  <svg
                                      width="24"
                                      height="24"
                              ...
                              <div className="mb-2">
                                  <h5
                                  className="card-title mb-0 fs-8 fs-md-6 text-gray-950 fw-bold"
                                  >
                                  深蹲護膝
                                  </h5>
                              </div>
                              ...
                              <div className="d-flex">
                                  ...
                                  <p className="card-text fs-8 fs-md-6 text-gray-950 fw-bold">
                                      <span className="me-1">$799</span>
                                      <span
                                      className="fs-8 text-gray-500 fw-bold text-decoration-line-through"
                                      >
                                      $1,099
                                      </span>
                                  </p>
                                  ...
                                  {/* 折扣標籤 */}
                                  <span
                                  className="badge fs-9 fs-md-8 text-warning-normal fw-bold border rounded-3 border-warning-normal ms-auto"
                                  >68 折</span
                                  >
                              </div>
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          className="card rounded-3 bg-blue-600 flex-grow-0 flex-shrink-0 hover-effect-3 overflow-hidden"
                          >
                          <a className="rounded-3 position-relative" href="product_details.html">
                              <div>
                              {/* 商品圖 */}
                              <div>
                                  <img
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_3.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_5.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                              ...
                              >
                                  {/* 優惠標籤 */}
                                  <div className="pt-6 ps-6 d-none">
                                  <span
                                      className="badge py-1 px-6 bg-danger-normal fs-8 text-white fw-bold"
                                      >熱銷</span
                                  >
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_7.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/商城/product-3.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_8.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_9.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_2.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_4.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_6.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/product_list_page/product-list_10.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/商城/product-6.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/商城/product-7.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/商城/product-8.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/商城/product-5.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/banner/Home Page2.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/服務項目/多元入場方案.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/服務項目/團體教練課程.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/服務項目/運動深層按摩服務.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
                      ...
                      <div className="col-6 col-sm-4 plr-10 mb-6 mb-md-7">
                          ...
                          <a className="rounded-3 position-relative" href="#">
                              ...
                              <div>
                                  <img
                                  src="../assets/images/index_page/教練/coach-5.jpg"
                                  className="card-img-top cardlist-img-h"
                                  alt="..."
                                  />
                              </div>
